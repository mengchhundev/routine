...
/**
 * Turns every exception into the one documented error shape. Nothing about the
 * internals of a failure reaches the client: unexpected exceptions are logged
 * with their stack trace and answered with a generic 500.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAccessDenied(AccessDeniedException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ApiError.of("FORBIDDEN", "You do not have access to this resource"));
    }
    ...
    public ResponseEntity<ApiError> handleNoHandler(NoHandlerFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ApiError.of("ENDPOINT_NOT_FOUND", "Endpoint was not found"));
    }
